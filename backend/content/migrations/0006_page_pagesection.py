    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_uk', ckeditor.fields.RichTextField(blank=True, verbose_name='Контент (українською)')),
                ('content_en', ckeditor.fields.RichTextField(blank=True, verbose_name='Content (English)')),
